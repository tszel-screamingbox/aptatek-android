...
public final class Constants {
    ...
    public static final float DEFAULT_PKU_INCREASED_FLOOR = 121f;
    public static final float DEFAULT_PKU_INCREASED_CEIL = 360f;
    public static final float DEFAULT_PKU_HIGH_RANGE = 840f;
