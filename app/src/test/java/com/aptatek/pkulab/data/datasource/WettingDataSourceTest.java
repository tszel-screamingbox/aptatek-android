...
public class WettingDataSourceTest {
    ...
    @Test
    public void testWettingDataSourceCallsPrefManager() throws Exception {
        wettingDataSource.getWettingStart();
        verify(preferenceManager).getWettingStart();

        wettingDataSource.getWettingStatus();
        verify(preferenceManager, atLeast(1)).getWettingStart();
    }
    ...
    public void testGetWettingStatusReturnsNotStartedWhenNoTestsWereRun() throws Exception {
        ...
        assert (wettingDataSource.getWettingStatus() == WettingStatus.NOT_STARTED);
    }
    ...
    public void testGetWettingStatusReturnsRunningWhenTestIsRunning() throws Exception {
        ...
        assert (wettingDataSource.getWettingStatus() == WettingStatus.RUNNING);
    }
    ...
    public void testGetWettingStatusReturnsFinishedWhenWettingPeriodExpired() throws Exception {
        ...
        assert (wettingDataSource.getWettingStatus() == WettingStatus.FINISHED);
    }
